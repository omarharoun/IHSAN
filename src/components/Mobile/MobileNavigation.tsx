...
interface MobileNavigationProps {
  activeApp: 'mindflow' | 'ihsan' | 'mawrid';
  onAppChange: (app: 'mindflow' | 'ihsan' | 'mawrid') => void;
  onOpenChat: () => void;
}
...
export function MobileNavigation({ activeApp, onAppChange, onOpenChat }: MobileNavigationProps) {
  ...
  const handleAppChange = (app: 'mindflow' | 'ihsan' | 'mawrid') => {
    onAppChange(app);
    setIsMenuOpen(false);
  };
        ...
        <div className="flex items-center justify-between px-4 py-3">
          ...
          <div className="flex items-center space-x-3">
            ...
            <h1 className="text-mobile-lg font-bold text-white">
              {activeApp === 'mindflow' ? 'MindFlow' : activeApp === 'ihsan' ? 'IHSAN' : 'Mawrid'}
            </h1>
          </div>
                  ...
                  <div className="p-6 border-b border-gray-800">
                    ...
                    <div className="space-y-2">
                      ...
                      <motion.button
                        whileHover={{ scale: 1.02 }}
                        whileTap={{ scale: 0.98 }}
                        onClick={() => handleAppChange('mawrid')}
                        className={`w-full flex items-center space-x-3 p-4 rounded-xl transition-colors ${
                          activeApp === 'mawrid'
                      ...
                      >
                        ...
                        <span className="font-medium">Mawrid</span>
                      </motion.button>
                    </div>
                  </div>
